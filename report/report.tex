...
\begin{abstract}
	...
	In this paper, we describe a new, comprehensive, open source dataset of 210+ Boolean network models compiled from available databases and a literature survey. The models are available in a wide range of formats. Furthermore, the dataset is accompanied by a validation pipeline that ensures the integrity and logical consistency of each model. Using this pipeline, we identified and repaired many potential problems in a number of widely used models.
\end{abstract}
\begin{document}
...
\begin{figure}
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot coordinates {(CellCollective,78) (GINsim,83) (Disease Map,22) (Biomodels,18) (Other,44)};			
