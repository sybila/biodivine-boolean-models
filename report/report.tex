...
\begin{center}
	...
	\begin{tabular}{ | C{16pt} | C{149pt} | C{25pt} | C{25pt} | C{25pt} | C{36pt} | }
		...
		\hline
		092 & \texttt{HEPATOCELLULAR CARCINOMA} & 61 & 8 & 139 & \cite{bbm-092} \\
		\hline
		...
		\hline
		100 & \texttt{ACUTE MYELOID LEUKEMIA} & 19 & 4 & 31 & \cite{bbm-100} \\
		\hline
		101 & \texttt{GUARD CELL CO2 SIGNALLING} & 62 & 25 & 156 & \cite{bbm-101} \\
		\hline
		102 & \texttt{PANCREATIC CANCER MICROENVIRONMENT REDUCED} & 18 & 6 & 53 & \cite{bbm-102-103} \\
		\hline
		103 & \texttt{PANCREATIC CANCER MICROENVIRONMENT} & 66 & 5 & 111 & \cite{bbm-102-103} \\
		\hline
		104 & \texttt{DROSOPHILA CELL CYCLE} & 11 & 3 & 42 & \cite{bbm-104, ginsim} \\
		\hline
		105 & \texttt{PLANT GUARD CELL SIGNALLING} & 47 & 4 & 114 & \cite{bbm-105} \\
		\hline
 	...
 	\begin{tabular}{ | C{16pt} | C{149pt} | C{25pt} | C{25pt} | C{25pt} | C{36pt} | }
		...
		134 & \texttt{RHEUMATOID ARTHRITIS} & 35 & 3 & 59 & \cite{bbm-134} \\
 		...
 		\hline
		140 & \texttt{BREAST CANCER DRUG RESISTANCE} & 63 & 19 & 212 & \cite{bbm-140} \\
 		\hline
		...
		143 & \texttt{BREAST CANCER INHIBITORS} & 71 & 26 & 223 & \cite{bbm-143} \\
 		\hline
		144 & \texttt{SNF1-AMPK-PATHWAY} & 147 & 57 & 483 & \cite{bbm-144} \\
 		\hline
	 ...
	 \begin{tabular}{ | C{16pt} | C{149pt} | C{25pt} | C{25pt} | C{25pt} | C{36pt} | }
	 	...
	 	\hline
	 	173 & \texttt{GLUCOSE REPRESSION SIGNALLING} & 63 & 15 & 117 & \cite{bbm-173} \\
	 	\hline
	 	174 & \texttt{----} & & & & \\
	 	\hline
