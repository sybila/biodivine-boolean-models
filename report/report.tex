...
\begin{itemize}
	...
	\item A human-readable name. For simplicity, the name is limited to numbers, capital letters and the dash symbol (e.g. \texttt{MODEL-NAME-5}). To improve legibility, we may use a regular space instead of a dash in text that is not meant to be machine readable (i.e. \texttt{MODEL NAME 5}).
\end{itemize}

\paragraph{Validation and canonical representation}

\paragraph{Collaboration and contributions} TODO

\section{Technical information}

To make the benchmark set as user friendly as possible, we provide the following benefits compared to existing solutions:
...
\begin{center}
	...
	\begin{tabular}{ | C{16pt} | C{149pt} | C{25pt} | C{25pt} | C{25pt} | C{36pt} | }
	 ...
	 \begin{tabular}{ | C{16pt} | C{149pt} | C{25pt} | C{25pt} | C{25pt} | C{36pt} | }
	 	...
	 	\hline
	 	173 & \texttt{GLUCOSE REPRESSION SIGNALLING} & 62 & 14 & 116 & \cite{bbm-173} \\
	 	\hline
