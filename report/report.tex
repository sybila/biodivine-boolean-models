...
\begin{center}
	\begin{tabular}{ | C{20pt} | C{160pt} | C{30pt} | C{30pt} | C{40pt} | }
		\hline
		ID & Name & Vars. & Regs. & Source \\ \hline
		001 & \texttt{SIGNALING IN MACROPHAGE ACTIVATION} & 321 & 533 & \cite{bbm-001, cell-collective} \\ \hline
		002 & \texttt{SIGNAL TRANSDUCTION IN FIBROBLASTS} & & & \cite{bbm-002, cell-collective} \\ \hline
		003 & \texttt{MAMMALIAN CELL CYCLE} & & & \cite{bbm-003, cell-collective} \\ \hline
		004 & \texttt{ERBB RECEPTOR SIGNALING} & & & \cite{bbm-004, cell-collective}  \\ \hline
		005 & \texttt{FA/BRCA PATHWAY} & & & \cite{bbm-005, cell-collective} \\ \hline
		006 & \texttt{HGF SIGNALING IN KERATINOCYTES} & & & \cite{bbm-006, cell-collective} \\ \hline
		007 & \texttt{CORTICAL AREA DEVELOPMENT} & & & \cite{bbm-007, cell-collective} \\ \hline
		008 & \texttt{DEATH RECEPTOR SIGNALING} & & & \cite{bbm-008, cell-collective} \\ \hline
		009 & \texttt{YEAST APOPTOSIS} & & & \cite{bbm-009, cell-collective} \\ \hline
		010 & \texttt{CARDIAC-DEVELOPMENT} & & & \cite{bbm-010, cell-collective} \\ \hline
